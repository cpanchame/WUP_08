...
The best model was based on HEADLEN as seen by the adjusted R-squared, the prediction of the length for the bears 5, 15, 23 is 70.31, 51.94, 58.83.  


The actual length of the bear is    
`r bears$LENGTH[c(5,15,23)]`

The error in prediction for bear number 5 was about 8 inches, for bear number 15 the prediction is accurate, for bear number 23 the error was just under 6 inches.